...
exports.article = function (req, res) {
    //res.render('admin-table');
    if (req.session && req.session.loginUser) {
        res.render('admin-article', {loginUser: req.session.loginUser});       //这里取出来值，传到前端页面
    } else {
        res.render('admin-login');
    }
};
exports.comment = function (req, res) {
    //res.render('admin-table');
    if (req.session && req.session.loginUser) {
        res.render('admin-comment', {loginUser: req.session.loginUser});       //这里取出来值，传到前端页面
    } else {
        res.render('admin-login');
    }
};
...
exports.selectMessage = function (req, res) {
    adminModel.getSelectMessage(function (rs) {
...
exports.showMessage = function (req, res) {
    ...
    adminModel.getMessageCount(function (rs) {
        res.json(rs);

    })

}
exports.pageMessage = function (req, res) {
    var page = req.query.page;
    console.log("这是" + page);
    adminModel.getMessage(page, function (rs) {
        res.json(rs);
    })
};

exports.selectComment = function (req, res) {
    adminModel.getSelectComment(function (rs) {
...
exports.showComment = function (req, res) {
    ...
    adminModel.getCommentCount(function (rs) {
        res.json(rs);

    })

}
exports.pageComment = function (req, res) {
    var page = req.query.page;
    console.log("这是" + page);
    adminModel.getComment(page, function (rs) {
        res.json(rs);
    })
};

exports.selectArticle = function (req, res) {
    adminModel.getSelectArticle(function (rs) {
...
exports.showArticle = function (req, res) {
    ...
    adminModel.getArticleCount(function (rs) {
        res.json(rs);
...
exports.pageArticle = function (req, res) {
    var page = req.query.page;
    console.log("这是" + page);
    adminModel.getArticle(page, function (rs) {
        res.json(rs);
    })
};