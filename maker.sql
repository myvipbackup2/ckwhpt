...
-- Records of t_admin
-- ----------------------------
INSERT INTO `t_admin` VALUES ('1', 'xiaoming', '123456', '15776865531', '我是一个积极负责的人');
...
-- ----------------------------
INSERT INTO `t_article` VALUES ('1', '黑龙江大学信科学院', '1.png', '黑龙江大学信息科学与技术学院是在黑龙江大学现有计算机学科优势的基础上，以黑龙江大学信息与计算中心的现有教学资源及十几年的计算机教学经验为依托，采用新的教育教学方法，以培养从事计算机软件编程、软件开发、具备实际操作能力的复合型、应用型计算机软件编程人才为目的建立的。\r\n学院根据计算机行业知识更新迅速、应用技术更新换代快等特点，制定相应的教学计划，根据当今世界上计算机发展的最新变化开设专业课，注重学生基础理论培养，同时用实践课来指导教学，实验教学与理论教学的课时比例为1:1或更高，个别课程完全采用实践教学，从大学一年级就开始开设项目实践课，重在加强实验环节，使学生在上学的过程中能够接触到大量的项目实践机会；同时学院和省内多家计算机软件开发公司建立长期合作关系，使学生在上学期间有机会到公司去参加一些项目的设计和开发，逐渐提高学生的软件设计研发能力，为以后的工作就业打下坚实的基础。', '2016-06-16 12:32:56', '1', '0');
INSERT INTO `t_article` VALUES ('2', '信科师资力量师资力量', '2.png', '学院现有专职教师及实验教师40余人，均具有十几年的教学经验和丰富的科研经历，其中教授、副教授19人，获得硕士以上学位及在读博士人员30多人。设有工程实训中心和专业基础、网络技术、信息技术三个教研室；工程实训中心的教师均具有10年以上计算机行业工程师的工作经历，部分教师具有国内外知名厂商的网络认证工程师或讲师资格。近年来学院先后承担科研项目40余项，教师发表学术论文100余篇，其中SCI、EI、ISTP论文70余篇。学院拥有一流的实验教学设备和先进的多媒体教学设备，有先进的信息网络技术实验室和计算机应用实验室；现有28个计算机教学实验室，总面积4000多平方米，微机1800多台，并且可以通过校园网接入Internet。', '2016-06-16 12:32:56', '2', '0');
INSERT INTO `t_article` VALUES ('3', '信科专业指南', '3.png', '培养目标：本专业培养具有良好的科学素养，系统地掌握信息科学的基本理论，熟练运用信息网络技术，具备信息化软件研发与管理能力，能从事网络工程建设与管理、信息化软件项目的研发与管理等工作的多层次、工程型、应用型的高级专门人才。\r\n主要课程：高等数学等、大学物理、语言程序设计、数据结构与算法、数据库原理与应用、计算机组成与通信原理、网络原理与应用、信息网络安全技术、网络工程技术应用与管理、网络操作系统原理与应用、3G及无线网络技术、Java等现代网络编程技术应用、嵌入式系统设计与实现等必修和选修课程。该专业理科考生报考。[1] \r\n该专业理科考生报考。\r\n从2015年开始，信息科学与技术学院开始招收研究生', '2016-06-16 12:32:57', '3', '0');
INSERT INTO `t_article` VALUES ('4', '黑龙江大学信息科学与技术学院', '1.png', '黑龙江大学信息科学与技术学院是在黑龙江大学现有计算机学科优势的基础上，以黑龙江大学信息与计算中心的现有教学资源及十几年的计算机教学经验为依托，采用新的教育教学方法，以培养从事计算机软件编程、软件开发、具备实际操作能力的复合型、应用型计算机软件编程人才为目的建立的。\r\n学院根据计算机行业知识更新迅速、应用技术更新换代快等特点，制定相应的教学计划，根据当今世界上计算机发展的最新变化开设专业课，注重学生基础理论培养，同时用实践课来指导教学，实验教学与理论教学的课时比例为1:1或更高，个别课程完全采用实践教学，从大学一年级就开始开设项目实践课，重在加强实验环节，使学生在上学的过程中能够接触到大量的项目实践机会；同时学院和省内多家计算机软件开发公司建立长期合作关系，使学生在上学期间有机会到公司去参加一些项目的设计和开发，逐渐提高学生的软件设计研发能力，为以后的工作就业打下坚实的基础。', '2016-06-16 12:32:58', '1', '0');
INSERT INTO `t_article` VALUES ('5', '黑龙江大学信息科学与技术学院', '2.png', '黑龙江大学信息科学与技术学院是在黑龙江大学现有计算机学科优势的基础上，以黑龙江大学信息与计算中心的现有教学资源及十几年的计算机教学经验为依托，采用新的教育教学方法，以培养从事计算机软件编程、软件开发、具备实际操作能力的复合型、应用型计算机软件编程人才为目的建立的。\r\n学院根据计算机行业知识更新迅速、应用技术更新换代快等特点，制定相应的教学计划，根据当今世界上计算机发展的最新变化开设专业课，注重学生基础理论培养，同时用实践课来指导教学，实验教学与理论教学的课时比例为1:1或更高，个别课程完全采用实践教学，从大学一年级就开始开设项目实践课，重在加强实验环节，使学生在上学的过程中能够接触到大量的项目实践机会；同时学院和省内多家计算机软件开发公司建立长期合作关系，使学生在上学期间有机会到公司去参加一些项目的设计和开发，逐渐提高学生的软件设计研发能力，为以后的工作就业打下坚实的基础。', '2016-06-16 12:32:59', '1', '0');
INSERT INTO `t_article` VALUES ('6', '黑龙江大学信息科学与技术学院', '3.png', '黑龙江大学信息科学与技术学院是在黑龙江大学现有计算机学科优势的基础上，以黑龙江大学信息与计算中心的现有教学资源及十几年的计算机教学经验为依托，采用新的教育教学方法，以培养从事计算机软件编程、软件开发、具备实际操作能力的复合型、应用型计算机软件编程人才为目的建立的。\r\n学院根据计算机行业知识更新迅速、应用技术更新换代快等特点，制定相应的教学计划，根据当今世界上计算机发展的最新变化开设专业课，注重学生基础理论培养，同时用实践课来指导教学，实验教学与理论教学的课时比例为1:1或更高，个别课程完全采用实践教学，从大学一年级就开始开设项目实践课，重在加强实验环节，使学生在上学的过程中能够接触到大量的项目实践机会；同时学院和省内多家计算机软件开发公司建立长期合作关系，使学生在上学期间有机会到公司去参加一些项目的设计和开发，逐渐提高学生的软件设计研发能力，为以后的工作就业打下坚实的基础。', '2016-06-16 12:33:00', '1', '0');
INSERT INTO `t_article` VALUES ('7', '黑龙江大学信科学院', '1.png', '黑龙江大学信息科学与技术学院是在黑龙江大学现有计算机学科优势的基础上，以黑龙江大学信息与计算中心的现有教学资源及十几年的计算机教学经验为依托，采用新的教育教学方法，以培养从事计算机软件编程、软件开发、具备实际操作能力的复合型、应用型计算机软件编程人才为目的建立的。\r\n学院根据计算机行业知识更新迅速、应用技术更新换代快等特点，制定相应的教学计划，根据当今世界上计算机发展的最新变化开设专业课，注重学生基础理论培养，同时用实践课来指导教学，实验教学与理论教学的课时比例为1:1或更高，个别课程完全采用实践教学，从大学一年级就开始开设项目实践课，重在加强实验环节，使学生在上学的过程中能够接触到大量的项目实践机会；同时学院和省内多家计算机软件开发公司建立长期合作关系，使学生在上学期间有机会到公司去参加一些项目的设计和开发，逐渐提高学生的软件设计研发能力，为以后的工作就业打下坚实的基础。', '2016-06-16 12:33:02', '1', '0');
...
INSERT INTO `t_user` VALUES ('3', 'xiaohua', 'memberhead2.png', '123456', '15203708701', '2016-06-11 13:01:33');
...
-- ----------------------------
INSERT INTO `t_user_detail` VALUES ('1', '女', '1', '1', '1', '1', '1', null, null);
